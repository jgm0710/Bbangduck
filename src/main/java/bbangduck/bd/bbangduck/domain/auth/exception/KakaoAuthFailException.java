...
public class KakaoAuthFailException extends SocialAuthFailException {
    public KakaoAuthFailException(SocialAuthFailResponseAdaptor socialAuthFailResponseAdaptor) {
        super(ResponseStatus.KAKAO_USER_NOT_FOUND, socialAuthFailResponseAdaptor);
    }
}
