...
public enum ResponseStatus {
     ...
     * 시작 코드 3
     */
    UPLOAD_IMAGE_FILE_SUCCESS(3201, "이미지 파일 업로드에 성공하였습니다.", "이미지 파일 업로드에 성공한 경우"),
    ...
    FILE_NAME_CONTAINS_WRONG_PATH(3403, "업로드를 요청한 파일의 이름에 잘 못된 경로가 포함되어 있어 업로드에 실패하였습니다.", "업로드를 시도한 파일의 파일명이 .. 등을 포함한 경우"),
    ...
    STORED_FILE_NOT_FOUND_IN_DATABASE(3407, "요청한 파일은 저장되지 않은 파일입니다.", "파일을 조회할 때, 데이터베이스에 해당 파일이 존재하지 않을 경우"),
