...
//    CREATE_DETAIL_REVIEW_NOT_VALID(4403, "상세 리뷰 생성 요청 시 기입 사항을 올바르게 기입하지 않았습니다.", "상세 리뷰 생성 요청 시 기입 사항을 올바르게 기입하지 않은 경우"),
    ...
    //todo 문서에 아래 code 변경 사항 반영
    REVIEW_CREATED_BY_OTHER_MEMBERS(4408, "다른 회원이 생성한 리뷰는 조작할 수 없습니다.", "다른 회원이 생성한 리뷰의 데이터를 변경하는 경우"),
...
//    DELETE_REVIEW_CREATED_BY_OTHER_MEMBERS(4426, "다른 회원이 생성한 리뷰는 삭제할 수 없습니다.", "다른 회원이 생성한 리뷰를 삭제하는 경우"),
    ...
    GET_THEME_LIST_NOT_VALID(5403, "테마 목록 조회 시 조건이 올바르게 기입되지 않았습니다.", "테마 목록 조회 시 조회 조건이 올바르게 기입되지 않은 경우"),
    GET_THEME_PLAY_MEMBER_LIST_NOT_VALID(5404, "테마를 플레이한 회원 목록 조회 시 기입 사항을 올바르게 기입하지 않았습니다.", "테마를 플레이한 회원 목록 조회 시 기입 사항을 올바르게 기입하지 않은 경우"),
    THEME_PLAY_MEMBER_NOT_FOUND(5405, "해당 회원이 해당 테마를 플레이한 내역이 존재하지 않습니다.", "테마 플레이 회원 1건 조회 시 테마 플레이 내역이 존재하지 않는 경우"),
    ...
    ALREADY_FOLLOW_MEMBER(7406, "이미 팔로우한 회원은 다시 팔로우 할 수 없습니다.", "이미 팔로우한 회원을 다시 팔로우하는 경우"),
    FOLLOW_NOT_FOUND(7407, "팔로우 내역을 찾을 수 없습니다.", "팔로우 내역 조회 시 팔로우 내역을 찾을 수 없는 경우"),
