...
//        List<Long> friendIds = createFriendToMember(memberSocialSignUpRequestDto, signUpId);
    ...
    public void getReviewList() throws Exception {
        ...
        perform
                ...
                .andExpect(jsonPath("totalPagesCount").exists())
                .andExpect(jsonPath("prevPageUrl").exists())
                .andExpect(jsonPath("nextPageUrl").exists())
                .andDo(document(
                        ...
                        relaxedResponseFields(
                                ...
                                fieldWithPath("totalPagesCount").description("요청 시 입력한 pageNum, amount, sortCondition 에 의해 조회된 결과의 총 페이지 수"),
